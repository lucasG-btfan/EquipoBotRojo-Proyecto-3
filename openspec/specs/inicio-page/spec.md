...
Define el comportamiento de la página de Inicio del dashboard SIEM: presentación profesional del sistema, indicador de estado general basado en contenedores Docker, grid de tecnologías del stack y navegación al dashboard principal.
